...
namespace OverlayImages
{
    ...
    public class OverlayImage : Form
    {
        ...
        /// 
        /// </summary>
        /// <param name="filename">eg. "splat.png"</param>
        /// <param name="opacity">From 0-255, 0 being transparent</param>
        public OverlayImage(string filename,byte opacity)
        {
            ...
            SetActiveWindow(wnd);
            this.TopMost = true;
            SetBitmap(filename, opacity);
        }

        public OverlayImage(string filename, byte opacity,bool showintaskbar)
        {
        ...
        bool _candrag = true;
        public void CanDrag(bool candrag) { _candrag = candrag; }
        ...
        public void SetBitmap(string filename, byte opacity)
        {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                if (!ShowInTaskbar)cp.ExStyle |= 0x00000080;
